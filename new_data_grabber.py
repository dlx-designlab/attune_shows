...
class DataGrabber:
    ...
    def __init__(self):
        self.remote_path = '~/Projects/Attune/scope_control_app/static/captured_pics/'
    ...
    def check_remote_data(self):
        ...
        print(f"Local Directories: {local_dirs}")
        ...
        for line in stdout:
            ...
            # print('... ' + line.strip('\n'))
        print(f"Remote Directories: {remote_dirs}")
        ...
        for dir in new_dirs:
            ...
            stdin, stdout, stderr = client.exec_command(
                f'find {self.remote_path + dir} -name "*stitched..png" -o -name "*.csv"'
            )
            time.sleep(1)
